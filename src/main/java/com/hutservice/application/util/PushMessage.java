...
//    private static final String apiKey = "OLzGspbMGAV3Td0hjxujPKkT";
//    //secretKey与ApiKey配套使用
//    private static final String secretKey = "68z9liuCZwUbyRob1LXknX5jjMnZfGsB";
...
//     */
//    //消息入参太多
//    public void pushMessageToBatch(String[] channelId, Integer[] deviceType, String title, String description) throws Exception {
//        try {
////            if ( deviceType == 3 ) {
//                // 4. specify request arguments
//                //创建Android通知
